...
public final class RecentlyPlayedListFragment_ extends RecentlyPlayedListFragment implements HasViews, OnViewChangedListener {
    private View contentView_;
    private Handler handler_;
    private final OnViewChangedNotifier onViewChangedNotifier_;

    public RecentlyPlayedListFragment_() {
    ...
    public void CurrentEventAvailable(NRCurrentEvent event) {
        super.CurrentEventAvailable(event);
    }
}
