...
public class Bus {
    ...
    Bus(ThreadEnforcer enforcer, String identifier, HandlerFinder handlerFinder) {
        ...
        this.eventsToDispatch = new 1(this);
        this.isDispatching = new 2(this);
    ...
    public void register(Object object) {
        ...
        for (Class<?> type : foundProducers.keySet()) {
            ...
            if (previousProducer != null) {
                throw new IllegalArgumentException("Producer method for type " + type + " found on type " + producer.target.getClass() + ", but already registered by type " + previousProducer.target.getClass() + ActiveMQDestination.PATH_SEPERATOR);
            }
