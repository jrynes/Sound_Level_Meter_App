...
public final class AdSize {
    ...
    static {
        ...
        BANNER = new AdSize(AMQP.CONNECTION_FORCED, PORTRAIT_AD_HEIGHT, "mb");
        IAB_MRECT = new AdSize(300, Type.TSIG, "as");
        IAB_BANNER = new AdSize(468, 60, "as");
        IAB_LEADERBOARD = new AdSize(728, LARGE_AD_HEIGHT, "as");
        IAB_WIDE_SKYSCRAPER = new AdSize(160, SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT, "as");
    }
