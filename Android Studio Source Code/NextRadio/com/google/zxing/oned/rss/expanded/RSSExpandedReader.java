...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    static {
        ...
        WEIGHTS = new int[][]{new int[]{FINDER_PAT_B, FINDER_PAT_D, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, 143, 7, 21, 63}, new int[]{189, 145, 13, 39, Service.UUCP_PATH, Service.EMFIS_DATA, 209, 205}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, Service.PROFILE, 197, 169, 85, 44, Service.CISCO_SYS}, new int[]{185, Service.STATSRV, 188, Service.BL_IDM, FINDER_PAT_E, 12, 36, 108}, new int[]{Service.AUTH, Flags.FLAG8, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, Service.NTP, 158, 52, 156}, new int[]{46, Service.NETBIOS_DGM, 203, 187, Service.NETBIOS_SSN, AMQP.FRAME_END, 196, 166}, new int[]{76, 17, 51, 153, 37, Service.SUNRPC, 122, 155}, new int[]{43, Service.PWDGEN, 176, 106, Service.RTELNET, Recover.INDEX, Service.NNTP, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{Service.POP_2, 116, Service.NETBIOS_NS, AMQP.REPLY_SUCCESS, 178, 112, Service.LOCUS_MAP, 164}, new int[]{70, 210, 208, 202, 184, Service.CISCO_FNA, 179, Service.SFTP}, new int[]{Service.INGRES_NET, 191, 151, 31, 93, 68, 204, 190}, new int[]{148, 22, 66, 198, 172, 94, 71, FINDER_PAT_C}, new int[]{6, 18, 54, 162, 64, 192, 154, 40}, new int[]{Nack.INDEX, 149, 25, 75, 14, 42, TransportMediator.KEYCODE_MEDIA_PLAY, 167}, new int[]{79, 26, 78, 23, 69, 207, 199, 175}, new int[]{Service.X400, 98, 83, 38, 114, Service.CISCO_TNA, 182, 124}, new int[]{161, 61, 183, Service.LOCUS_CON, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, FINDER_PAT_F, 15}, new int[]{45, Service.LOC_SRV, 194, 160, 58, 174, 100, 89}};
