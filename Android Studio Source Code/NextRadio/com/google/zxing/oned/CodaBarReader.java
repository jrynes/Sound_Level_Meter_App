...
public final class CodaBarReader extends OneDReader {
    ...
    static {
        ...
        CHARACTER_ENCODINGS = new int[]{3, minCharacterLength, 9, 96, 18, 66, 33, 36, 48, 72, 12, 24, 69, 81, 84, 21, 26, 41, 11, 14, 26, 41};
    ...
    public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        if (nextStart != end && whiteSpaceAfterEnd / 2 < lastPatternSize) {
            ...
            if (arrayContains(STARTEND_ENCODING, startchar)) {
                ...
                r24 = new ResultPoint[2];
                r24[0] = new ResultPoint(left, (float) rowNumber);
                r24[1] = new ResultPoint(right, (float) rowNumber);
                return new Result(stringBuilder, null, r24, BarcodeFormat.CODABAR);
            }
            throw NotFoundException.getNotFoundInstance();
        }
    }
