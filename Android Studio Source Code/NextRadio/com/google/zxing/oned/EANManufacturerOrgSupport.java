...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, Service.NETBIOS_SSN}, "US/CA");
            ...
            add(new int[]{ActiveMQPrefetchPolicy.DEFAULT_QUEUE_BROWSER_PREFETCH, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{AMQP.NOT_IMPLEMENTED, 549}, "BE/LU");
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{Constants.ANIMATION_DURATION, 709}, "NO");
            add(new int[]{729}, "IL");
