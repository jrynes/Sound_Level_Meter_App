...
final class PDF417HighLevelEncoder {
    ...
    static {
        byte i;
        TEXT_MIXED_RAW = new byte[]{(byte) 48, (byte) 49, JournalTopicAck.DATA_STRUCTURE_TYPE, (byte) 51, JournalQueueAck.DATA_STRUCTURE_TYPE, JournalTrace.DATA_STRUCTURE_TYPE, JournalTransaction.DATA_STRUCTURE_TYPE, SubscriptionInfo.DATA_STRUCTURE_TYPE, (byte) 56, (byte) 57, (byte) 38, MarshallingSupport.BIG_STRING_TYPE, (byte) 9, (byte) 44, Stomp.COLON, (byte) 35, (byte) 45, (byte) 46, (byte) 36, (byte) 47, (byte) 43, (byte) 37, (byte) 42, LastPartialCommand.DATA_STRUCTURE_TYPE, (byte) 94, (byte) 0, DataResponse.DATA_STRUCTURE_TYPE, (byte) 0, (byte) 0, (byte) 0};
        TEXT_PUNCTUATION_RAW = new byte[]{(byte) 59, PartialCommand.DATA_STRUCTURE_TYPE, (byte) 62, (byte) 64, NetworkBridgeFilter.DATA_STRUCTURE_TYPE, Stomp.ESCAPE, (byte) 93, (byte) 95, (byte) 96, (byte) 126, DataArrayResponse.DATA_STRUCTURE_TYPE, MarshallingSupport.BIG_STRING_TYPE, (byte) 9, (byte) 44, Stomp.COLON, (byte) 10, (byte) 45, (byte) 46, (byte) 36, (byte) 47, IntegerResponse.DATA_STRUCTURE_TYPE, CommandTypes.BROKER_ID, (byte) 42, DiscoveryEvent.DATA_STRUCTURE_TYPE, (byte) 41, (byte) 63, ProducerId.DATA_STRUCTURE_TYPE, (byte) 125, (byte) 39, (byte) 0};
        MIXED = new byte[Flags.FLAG8];
        PUNCTUATION = new byte[Flags.FLAG8];
    ...
    private static void encodeBinary(byte[] bytes, int startpos, int count, int startmode, StringBuilder sb) {
        ...
        if (count >= 6) {
            ...
            while ((startpos + count) - idx >= 6) {
                ...
                for (i = SUBMODE_ALPHA; i < 6; i += SUBMODE_LOWER) {
                    t = (t << 8) + ((long) (bytes[idx + i] & Type.ANY));
                }
        ...
        for (i = idx; i < startpos + count; i += SUBMODE_LOWER) {
            sb.append((char) (bytes[i] & Type.ANY));
        }
    }
