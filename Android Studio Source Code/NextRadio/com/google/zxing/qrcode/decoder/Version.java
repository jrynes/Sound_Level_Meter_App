...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(4, Service.RTELNET));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, Service.SFTP), new ECB(1, 116));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(1, Service.RTELNET), new ECB(5, 108));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, Nack.INDEX), new ECB(1, Service.ERPC));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, Service.AUTH), new ECB(4, 114));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, Service.RTELNET), new ECB(5, 108));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(2, Service.SUNRPC), new ECB(7, 112));
        ...
        iArr = new int[]{6, 30, 54, 78, Service.ISO_TSAP};
        eCBlocksArr = new ECBlocks[4];
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, Service.UUCP_PATH), new ECB(4, 118));
        ...
        iArr = new int[]{6, 32, 58, 84, Recover.INDEX};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(8, 106), new ECB(4, Service.RTELNET));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, 114), new ECB(2, Service.SFTP));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, Service.UUCP_PATH), new ECB(10, 118));
        ...
        iArr = new int[]{6, 30, 54, 78, Service.ISO_TSAP, TransportMediator.KEYCODE_MEDIA_PLAY};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 52, 78, Service.X400_SND, Service.CISCO_FNA};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, Service.SFTP), new ECB(10, 116));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, Service.SFTP), new ECB(3, 116));
        ...
        iArr = new int[]{6, 34, 60, 86, 112, Service.NETBIOS_DGM};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, Service.SFTP));
        ...
        iArr = new int[]{6, 30, 58, 86, 114, Service.BL_IDM};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, Service.SFTP), new ECB(1, 116));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, Service.SFTP), new ECB(6, 116));
        ...
        iArr = new int[]{6, 30, 54, 78, Service.ISO_TSAP, TransportMediator.KEYCODE_MEDIA_PLAY, 150};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 24, 50, 76, Service.ISO_TSAP, Flags.FLAG8, 154};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, 106, Service.CISCO_SYS, 158};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, Recover.INDEX, Service.PROFILE, 162};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 54, 82, Recover.INDEX, Service.NETBIOS_DGM, 166};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, Service.UUCP_PATH), new ECB(4, 118));
        ...
        iArr = new int[]{6, 30, 58, 86, 114, Service.BL_IDM, 170};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, 118), new ECB(6, Service.NNTP));
