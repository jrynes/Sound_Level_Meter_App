...
class zzb {
    ...
    private Uri zzdX(String str) {
        return TextUtils.isEmpty(str) ? null : (MulticastDiscoveryAgent.DEFAULT_HOST_STR.equals(str) || this.mContext.getResources().getIdentifier(str, "raw", this.mContext.getPackageName()) == 0) ? RingtoneManager.getDefaultUri(2) : Uri.parse("android.resource://" + this.mContext.getPackageName() + "/raw/" + str);
    }
