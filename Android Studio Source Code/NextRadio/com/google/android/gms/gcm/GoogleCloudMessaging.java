...
public class GoogleCloudMessaging {
    ...
    class C07241 extends Handler {
        final /* synthetic */ GoogleCloudMessaging zzaLV;

        C07241(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaLU = new Messenger(new C07241(this, Looper.getMainLooper()));
    }
    ...
    private String zzdZ(String str) {
        ...
        return InstanceID.getInstance(this.context).zzyB().zzi(Stomp.EMPTY, str, INSTANCE_ID_SCOPE);
    }

    private boolean zzr(Intent intent) {
        Object stringExtra = intent.getStringExtra("In-Reply-To");
        if (stringExtra == null && intent.hasExtra(Diagnostics.error)) {
    ...
    String zzc(String... strArr) {
        ...
        for (int i = 1; i < strArr.length; i++) {
            stringBuilder.append(ActiveMQDestination.COMPOSITE_SEPERATOR).append(strArr[i]);
        }
