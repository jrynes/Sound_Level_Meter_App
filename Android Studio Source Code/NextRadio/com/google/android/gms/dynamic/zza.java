...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C07101 implements zzf<T> {
        final /* synthetic */ zza zzavB;

        C07101(zza com_google_android_gms_dynamic_zza) {
    ...
    class C07112 implements zza {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ zza zzavB;
        final /* synthetic */ Bundle zzavC;
        final /* synthetic */ Bundle zzavD;

        C07112(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzavB = com_google_android_gms_dynamic_zza;
    ...
    class C07123 implements zza {
        final /* synthetic */ zza zzavB;
        final /* synthetic */ Bundle zzavD;

        C07123(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzavB = com_google_android_gms_dynamic_zza;
            this.zzavD = bundle;
        }
    ...
    class C07134 implements zza {
        ...
        C07134(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzavB = com_google_android_gms_dynamic_zza;
    ...
    static class C07145 implements OnClickListener {
        final /* synthetic */ int zzAe;
        final /* synthetic */ Context zzxh;

        C07145(Context context, int i) {
            this.zzxh = context;
            this.zzAe = i;
        }
    ...
    class C07156 implements zza {
        final /* synthetic */ zza zzavB;

        C07156(zza com_google_android_gms_dynamic_zza) {
            this.zzavB = com_google_android_gms_dynamic_zza;
        }
    ...
    class C07167 implements zza {
        final /* synthetic */ zza zzavB;

        C07167(zza com_google_android_gms_dynamic_zza) {
            this.zzavB = com_google_android_gms_dynamic_zza;
        }
    ...
    public static void zzb(FrameLayout frameLayout) {
        ...
        if (zzh != null) {
            ...
            button.setOnClickListener(new C07145(context, isGooglePlayServicesAvailable));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        zza(savedInstanceState, new C07123(this, savedInstanceState));
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        zza(savedInstanceState, new C07134(this, frameLayout, inflater, container, savedInstanceState));
        if (this.zzavx == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
        zza(savedInstanceState, new C07112(this, activity, attrs, savedInstanceState));
    }
