...
public final class NearbyAlertRequest implements SafeParcelable {
    ...
    public String toString() {
        return zzw.zzy(this).zzg("transitionTypes", Integer.valueOf(this.zzaNC)).zzg("loiteringTimeMillis", Integer.valueOf(this.zzaPr)).zzg("nearbyAlertFilter", this.zzaPt).zzg(Send.PRIORITY, Integer.valueOf(this.mPriority)).toString();
    }
