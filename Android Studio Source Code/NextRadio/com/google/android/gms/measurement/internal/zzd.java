...
public class zzd extends zzy {
    ...
    static {
        zzaVA = String.valueOf(zzc.GOOGLE_PLAY_SERVICES_VERSION_CODE / ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH).replaceAll("(\\d+)(\\d)(\\d\\d)", "$1.$2.$3");
    }
    ...
    int zzBH() {
        return ActiveMQPrefetchPolicy.DEFAULT_QUEUE_BROWSER_PREFETCH;
    }
    ...
    public long zzBp() {
        return (long) (zzc.GOOGLE_PLAY_SERVICES_VERSION_CODE / ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH);
    }
    ...
    public String zzH(String str, String str2) {
        ...
        builder.scheme((String) zzl.zzaWe.get()).authority((String) zzl.zzaWf.get()).path("config/app/" + str).appendQueryParameter("app_instance_id", str2).appendQueryParameter("platform", AbstractSpiCall.ANDROID_CLIENT_TYPE).appendQueryParameter("gmp_version", String.valueOf(zzBp()));
