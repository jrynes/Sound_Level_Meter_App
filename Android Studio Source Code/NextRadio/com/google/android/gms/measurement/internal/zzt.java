...
class zzt extends zzz {
    ...
    public final class zzc {
        ...
        public void zzf(String str, long j) {
            ...
            Object obj = (this.zzaXA.zzaXr.nextLong() & OpenWireFormat.DEFAULT_MAX_FRAME_SIZE) < (OpenWireFormat.DEFAULT_MAX_FRAME_SIZE / (j2 + j)) * j ? 1 : null;
    ...
    static {
        zzaXh = new Pair(Stomp.EMPTY, Long.valueOf(0));
    }
    ...
    zzt(zzw com_google_android_gms_measurement_internal_zzw) {
        ...
        this.zzaXs = new zzb(this, "time_before_start", ThreadPoolUtils.DEFAULT_SHUTDOWN_AWAIT_TERMINATION);
    ...
    String zzfi(String str) {
        ...
        if (zzaj.zzbv(CommonUtils.MD5_INSTANCE) == null) {
            return null;
        }
        return String.format(Locale.US, "%032X", new Object[]{new BigInteger(1, zzaj.zzbv(CommonUtils.MD5_INSTANCE).digest(str2.getBytes()))});
    }
