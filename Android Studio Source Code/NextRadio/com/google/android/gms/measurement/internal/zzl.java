...
public final class zzl {
    ...
    static {
        ...
        zzaWb = zza.zze("measurement.ad_id_cache_time", ThreadPoolUtils.DEFAULT_SHUTDOWN_AWAIT_TERMINATION);
        ...
        zzaWj = zza.zzD("measurement.upload.max_events_per_bundle", ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH);
        ...
        zzaWm = zza.zzD("measurement.upload.max_conversions_per_day", ActiveMQPrefetchPolicy.DEFAULT_QUEUE_BROWSER_PREFETCH);
