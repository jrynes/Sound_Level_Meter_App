...
public class zzp extends zzz {
    ...
    class C10061 implements Runnable {
        ...
        C10061(zzp com_google_android_gms_measurement_internal_zzp, String str) {
    ...
    static String zzc(boolean z, Object obj) {
        ...
        if (valueOf instanceof Long) {
            ...
            String str = String.valueOf(valueOf).charAt(0) == '-' ? "-" : Stomp.EMPTY;
    ...
    public String zzCL() {
        ...
        return zzlN == null ? null : String.valueOf(zzlN.second) + Headers.SEPERATOR + ((String) zzlN.first);
    }
    ...
    public void zzb(int i, String str, Object obj, Object obj2, Object obj3) {
        ...
        if (zzCU == null) {
            ...
            String str2 = "1" + "01VDIWEA?".charAt(i) + this.zzaWB + this.zzaVj + Headers.SEPERATOR + zza(true, str, obj, obj2, obj3);
            zzCU.zzg(new C10061(this, str2.length() > Flags.FLAG5 ? str.substring(0, Flags.FLAG5) : str2));
        }
    }
