...
public class zzw {
    ...
    class C10101 implements Runnable {
        ...
        C10101(zzw com_google_android_gms_measurement_internal_zzw) {
    ...
    class C10112 implements zza {
        final /* synthetic */ zzw zzaYs;

        C10112(zzw com_google_android_gms_measurement_internal_zzw) {
            this.zzaYs = com_google_android_gms_measurement_internal_zzw;
        }
    ...
    class C10123 implements zza {
        final /* synthetic */ zzw zzaYs;

        C10123(zzw com_google_android_gms_measurement_internal_zzw) {
            this.zzaYs = com_google_android_gms_measurement_internal_zzw;
        }
    ...
    zzw(zzaa com_google_android_gms_measurement_internal_zzaa) {
        ...
        this.zzaYa.zzg(new C10101(this));
    }
    ...
    private void zza(int i, Throwable th, byte[] bArr) {
        ...
        this.zzaYp = null;
        if ((i == AMQP.REPLY_SUCCESS || i == 204) && th == null) {
            ...
            if (i == AMQP.COMMAND_INVALID || i == 429) {
                i2 = 1;
            }
            if (i2 != 0) {
    ...
    private void zzb(String str, int i, Throwable th, byte[] bArr) {
        ...
        int i3 = ((i == AMQP.REPLY_SUCCESS || i == 204 || i == 304) && th == null) ? 1 : 0;
        if (i3 != 0 || i == AMQP.NOT_FOUND) {
            if (i == AMQP.NOT_FOUND || i == 304) {
        ...
        if (zzDb()) {
                ...
                if (!TextUtils.isEmpty(zzaa)) {
                    ...
                    if (zzeY != null) {
                        ...
                        try {
                            ...
                            zzCW().zza(zzaa, url, map, new C10123(this));
                            return;
            ...
            if (!zzn.isEmpty()) {
                ...
                try {
                    ...
                    zzCW().zza(zzCq, url2, zza, null, new C10112(this));
    ...
    void zza(zzh com_google_android_gms_measurement_internal_zzh, AppMetadata appMetadata) {
        ...
        com_google_android_gms_internal_zzqb_zze.zzbat = AbstractSpiCall.ANDROID_CLIENT_TYPE;
            ...
            if (!appMetadata.zzaVy) {
                ...
                try {
                    ...
                    if ("_iap".equals(eventParcel.name) || "ecommerce_purchase".equals(eventParcel.name)) {
                        ...
                        long j = zzCC.getLong(Constants.NATIVE_AD_VALUE_ELEMENT);
            ...
            if (appMetadata.zzaVy) {
                ...
                try {
                    ...
                    if (!(zzeY == null || zzeY.zzli() == null || zzeY.zzli().equals(appMetadata.zzaMV))) {
                        ...
                        zzb(new EventParcel("_au", new EventParams(bundle), StompSubscription.AUTO_ACK, currentTimeMillis), appMetadata);
                    }
                    zze(appMetadata);
                    if (zzCj().zzI(appMetadata.packageName, "_f") == null) {
                        zzb(new UserAttributeParcel("_fot", currentTimeMillis, Long.valueOf(((currentTimeMillis / 3600000) + 1) * 3600000), StompSubscription.AUTO_ACK), appMetadata);
                        bundle = new Bundle();
                        bundle.putLong("_c", 1);
                        zzb(new EventParcel("_f", new EventParams(bundle), StompSubscription.AUTO_ACK, currentTimeMillis), appMetadata);
                    } else if (appMetadata.zzaVz) {
                        zzb(new EventParcel("_cd", new EventParams(new Bundle()), StompSubscription.AUTO_ACK, currentTimeMillis), appMetadata);
                    }
                    zzCj().setTransactionSuccessful();
                } finally {
                    zzCj().endTransaction();
