...
public final class AppMeasurementService extends Service {
    ...
    class C09841 implements Runnable {
        ...
        class C09831 implements Runnable {
            final /* synthetic */ C09841 zzaTZ;

            C09831(C09841 c09841) {
                this.zzaTZ = c09841;
            }
        ...
        C09841(AppMeasurementService appMeasurementService, zzw com_google_android_gms_measurement_internal_zzw, int i, zzp com_google_android_gms_measurement_internal_zzp) {
        ...
        public void run() {
            this.zzaTW.zzDc();
            this.zzaTY.mHandler.post(new C09831(this));
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzaT.zzCn().zzg(new C09841(this, zzaT, startId, zzAo));
        }
        return 2;
    }
