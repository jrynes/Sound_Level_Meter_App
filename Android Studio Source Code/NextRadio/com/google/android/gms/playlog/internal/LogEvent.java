...
public class LogEvent implements SafeParcelable {
    ...
    public String toString() {
        ...
        stringBuilder.append("tag=").append(this.tag).append(Stomp.COMMA);
        stringBuilder.append("eventTime=").append(this.zzbdA).append(Stomp.COMMA);
        stringBuilder.append("eventUptime=").append(this.zzbdB).append(Stomp.COMMA);
        if (!(this.zzbdD == null || this.zzbdD.isEmpty())) {
            stringBuilder.append("keyValues=");
            for (String str : this.zzbdD.keySet()) {
                stringBuilder.append("(").append(str).append(Stomp.COMMA);
