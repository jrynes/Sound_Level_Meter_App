...
public final class TileOverlayOptions implements SafeParcelable {
    ...
    class C09811 implements TileProvider {
        private final zzi zzaTS;
        final /* synthetic */ TileOverlayOptions zzaTT;

        C09811(TileOverlayOptions tileOverlayOptions) {
    ...
    class C09822 extends zza {
        final /* synthetic */ TileOverlayOptions zzaTT;
        final /* synthetic */ TileProvider zzaTU;

        C09822(TileOverlayOptions tileOverlayOptions, TileProvider tileProvider) {
            this.zzaTT = tileOverlayOptions;
    ...
    TileOverlayOptions(int versionCode, IBinder delegate, boolean visible, float zIndex, boolean fadeIn) {
        ...
        this.zzaTQ = this.zzaTP == null ? null : new C09811(this);
        this.zzaTi = visible;
        this.zzaTh = zIndex;
        this.zzaTR = fadeIn;
    }
    ...
    public TileOverlayOptions tileProvider(TileProvider tileProvider) {
        ...
        this.zzaTP = this.zzaTQ == null ? null : new C09822(this, tileProvider);
        return this;
    }
