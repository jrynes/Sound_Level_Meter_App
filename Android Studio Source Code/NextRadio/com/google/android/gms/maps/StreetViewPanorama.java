...
public class StreetViewPanorama {
    ...
    class C09731 extends zza {
        final /* synthetic */ OnStreetViewPanoramaChangeListener zzaSs;
        final /* synthetic */ StreetViewPanorama zzaSt;

        C09731(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaChangeListener onStreetViewPanoramaChangeListener) {
    ...
    class C09742 extends zzw.zza {
        final /* synthetic */ StreetViewPanorama zzaSt;
        final /* synthetic */ OnStreetViewPanoramaCameraChangeListener zzaSu;

        C09742(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaCameraChangeListener onStreetViewPanoramaCameraChangeListener) {
            this.zzaSt = streetViewPanorama;
    ...
    class C09753 extends zzy.zza {
        final /* synthetic */ StreetViewPanorama zzaSt;
        final /* synthetic */ OnStreetViewPanoramaClickListener zzaSv;

        C09753(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaClickListener onStreetViewPanoramaClickListener) {
            this.zzaSt = streetViewPanorama;
    ...
    class C09764 extends zzz.zza {
        final /* synthetic */ StreetViewPanorama zzaSt;
        final /* synthetic */ OnStreetViewPanoramaLongClickListener zzaSw;

        C09764(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaLongClickListener onStreetViewPanoramaLongClickListener) {
            this.zzaSt = streetViewPanorama;
    ...
    public final void setOnStreetViewPanoramaCameraChangeListener(OnStreetViewPanoramaCameraChangeListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaCameraChangeListener(new C09742(this, listener));
    }
    ...
    public final void setOnStreetViewPanoramaChangeListener(OnStreetViewPanoramaChangeListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaChangeListener(new C09731(this, listener));
    }
    ...
    public final void setOnStreetViewPanoramaClickListener(OnStreetViewPanoramaClickListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaClickListener(new C09753(this, listener));
    }
    ...
    public final void setOnStreetViewPanoramaLongClickListener(OnStreetViewPanoramaLongClickListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaLongClickListener(new C09764(this, listener));
    }
