...
public final class PublisherAdRequest {
    ...
    public static final class Builder {
        ...
        public Builder addCustomTargeting(String key, List<String> values) {
            if (values != null) {
                this.zzoF.zza(key, zzv.zzcL(Stomp.COMMA).zza(values));
            }
            return this;
        }
        ...
        public Builder setContentUrl(String contentUrl) {
            ...
            boolean z = contentUrl.length() <= KEYRecord.OWNER_HOST;
            Object[] objArr = new Object[PublisherAdRequest.GENDER_FEMALE];
            objArr[PublisherAdRequest.ERROR_CODE_INTERNAL_ERROR] = Integer.valueOf(KEYRecord.OWNER_HOST);
