...
public final class AdSize {
    ...
    static {
        BANNER = new AdSize(AMQP.CONNECTION_FORCED, 50, "320x50_mb");
        FULL_BANNER = new AdSize(468, 60, "468x60_as");
        LARGE_BANNER = new AdSize(AMQP.CONNECTION_FORCED, 100, "320x100_as");
        LEADERBOARD = new AdSize(728, 90, "728x90_as");
        MEDIUM_RECTANGLE = new AdSize(300, Type.TSIG, "300x250_as");
        WIDE_SKYSCRAPER = new AdSize(160, SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT, "160x600_as");
    ...
    public int getHeightInPixels(Context context) {
        switch (this.zzoH) {
            case -4:
            case MPDbAdapter.DB_UNDEFINED_CODE /*-3*/:
                return FULL_WIDTH;
            case AUTO_HEIGHT /*-2*/:
