...
public class zzq {
    ...
    class C06431 implements Runnable {
        ...
        C06431(zzq com_google_android_gms_ads_internal_zzq, WeakReference weakReference) {
    ...
    zzq(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzq_zza) {
        ...
        this.zzx = new C06431(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
