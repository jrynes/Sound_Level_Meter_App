...
public class zzi {
    ...
    class C06131 implements ServiceConnection {
        final /* synthetic */ zzi zzFZ;
        final /* synthetic */ Context zzxh;

        C06131(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
    ...
    public void zzz(Context context) {
        ServiceConnection c06131 = new C06131(this, context);
        Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE);
        context.bindService(intent, c06131, 1);
    }
}
