...
public class zzc extends zzim implements ServiceConnection {
    ...
    class C06121 implements Runnable {
        ...
        C06121(zzc com_google_android_gms_ads_internal_purchase_zzc, zzf com_google_android_gms_ads_internal_purchase_zzf, Intent intent) {
    ...
    private void zze(long j) {
        do {
            if (!zzf(j)) {
                zzin.m1674v("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.zzFB);
    }
    ...
    protected void zza(zzf com_google_android_gms_ads_internal_purchase_zzf, String str, String str2) {
        ...
        zzir.zzMc.post(new C06121(this, com_google_android_gms_ads_internal_purchase_zzf, intent));
    }
