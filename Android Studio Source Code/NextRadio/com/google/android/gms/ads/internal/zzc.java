...
public abstract class zzc extends zzb implements zzg, zzft {
    ...
    class C06261 implements zzdf {
        final /* synthetic */ zzc zzpr;

        C06261(zzc com_google_android_gms_ads_internal_zzc) {
    ...
    class C06272 implements Runnable {
        ...
        C06272(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
    ...
    class C06303 implements Runnable {
        ...
        class C06281 implements OnTouchListener {
            final /* synthetic */ zze zzpu;
            final /* synthetic */ C06303 zzpv;

            C06281(C06303 c06303, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c06303;
        ...
        class C06292 implements OnClickListener {
            final /* synthetic */ zze zzpu;
            final /* synthetic */ C06303 zzpv;

            C06292(C06303 c06303, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c06303;
                this.zzpu = com_google_android_gms_ads_internal_zze;
            }
        ...
        C06303(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
            this.zzps = com_google_android_gms_internal_zzif_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C06281(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C06292(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zzeh com_google_android_gms_internal_zzeh) {
        com_google_android_gms_internal_zzeh.zza("/trackActiveViewUnit", new C06261(this));
    }
    ...
    protected void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C06272(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
        ...
        if (!com_google_android_gms_internal_zzif_zza.zzLe.zzHT || com_google_android_gms_internal_zzif_zza.zzLe.zzum) {
            zzir.zzMc.post(new C06303(this, com_google_android_gms_internal_zzif_zza, com_google_android_gms_internal_zzcb));
            return;
        }
        this.zzpj.zzrL = 0;
