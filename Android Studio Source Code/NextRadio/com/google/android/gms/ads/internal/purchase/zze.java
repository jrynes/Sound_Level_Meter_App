...
public class zze extends zza implements ServiceConnection {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CloseFrame.GOING_AWAY) {
            boolean z = false;
            try {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        try {
            ...
            this.mActivity.startIntentSenderForResult(pendingIntent.getIntentSender(), CloseFrame.GOING_AWAY, new Intent(), Integer.valueOf(0).intValue(), Integer.valueOf(0).intValue(), Integer.valueOf(0).intValue());
