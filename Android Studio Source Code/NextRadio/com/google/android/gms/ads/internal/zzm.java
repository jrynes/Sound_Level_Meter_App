...
public class zzm {
    ...
    static class C06341 implements zza {
        final /* synthetic */ zzd zzqq;
        final /* synthetic */ String zzqr;
        final /* synthetic */ zzjp zzqs;

        C06341(zzd com_google_android_gms_ads_internal_formats_zzd, String str, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, boolean z) {
            try {
                ...
                jSONObject.put(stations.headline, this.zzqq.getHeadline());
                ...
                jSONObject.put(SettingsJsonConstants.APP_ICON_KEY, zzm.zza(this.zzqq.zzdK()));
    ...
    static class C06352 implements zza {
        final /* synthetic */ String zzqr;
        final /* synthetic */ zzjp zzqs;
        final /* synthetic */ zze zzqt;

        C06352(zze com_google_android_gms_ads_internal_formats_zze, String str, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, boolean z) {
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(stations.headline, this.zzqt.getHeadline());
    ...
    static class C06363 implements zzdf {
        final /* synthetic */ CountDownLatch zzqu;

        C06363(CountDownLatch countDownLatch) {
    ...
    static class C06374 implements zzdf {
        final /* synthetic */ CountDownLatch zzqu;

        C06374(CountDownLatch countDownLatch) {
            this.zzqu = countDownLatch;
        }
    ...
    static class C06385 implements zzdf {
        final /* synthetic */ zzfb zzqv;
        final /* synthetic */ zzf.zza zzqw;
        final /* synthetic */ zzfc zzqx;

        C06385(zzfb com_google_android_gms_internal_zzfb, zzf.zza com_google_android_gms_ads_internal_zzf_zza, zzfc com_google_android_gms_internal_zzfc) {
    ...
    static zzdf zza(zzfb com_google_android_gms_internal_zzfb, zzfc com_google_android_gms_internal_zzfc, zzf.zza com_google_android_gms_ads_internal_zzf_zza) {
        return new C06385(com_google_android_gms_internal_zzfb, com_google_android_gms_ads_internal_zzf_zza, com_google_android_gms_internal_zzfc);
    }

    static zzdf zza(CountDownLatch countDownLatch) {
        return new C06363(countDownLatch);
    }
    ...
    private static JSONObject zza(Bundle bundle, String str) throws JSONException {
        ...
        while (keys.hasNext()) {
            ...
            if (bundle.containsKey(str2)) {
                if (Constants.NATIVE_AD_IMAGE_ELEMENT.equals(jSONObject2.getString(str2))) {
    ...
    private static void zza(zzjp com_google_android_gms_internal_zzjp, zzd com_google_android_gms_ads_internal_formats_zzd, String str) {
        com_google_android_gms_internal_zzjp.zzhU().zza(new C06341(com_google_android_gms_ads_internal_formats_zzd, str, com_google_android_gms_internal_zzjp));
    }
    ...
    private static void zza(zzjp com_google_android_gms_internal_zzjp, zze com_google_android_gms_ads_internal_formats_zze, String str) {
        com_google_android_gms_internal_zzjp.zzhU().zza(new C06352(com_google_android_gms_ads_internal_formats_zze, str, com_google_android_gms_internal_zzjp));
    }
    ...
    static zzdf zzb(CountDownLatch countDownLatch) {
        return new C06374(countDownLatch);
    }
    ...
    private static boolean zzb(zzjp com_google_android_gms_internal_zzjp, zzes com_google_android_gms_internal_zzes, CountDownLatch countDownLatch) throws RemoteException {
        ...
        if (str2 != null) {
            com_google_android_gms_internal_zzjp.loadDataWithBaseURL(str2, str, WebRequest.CONTENT_TYPE_HTML, HttpRequest.CHARSET_UTF8, null);
        } else {
            com_google_android_gms_internal_zzjp.loadData(str, WebRequest.CONTENT_TYPE_HTML, HttpRequest.CHARSET_UTF8);
        }
        return true;
    }
