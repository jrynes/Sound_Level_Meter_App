...
public class zzd extends com.google.android.gms.internal.zzfv.zza implements zzs {
    ...
    class C06101 implements com.google.android.gms.internal.zzjq.zza {
        final /* synthetic */ zzd zzEv;

        C06101(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzim {
        ...
        class C06111 implements Runnable {
            ...
            C06111(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbr() {
            ...
            if (zzf != null) {
                zzir.zzMc.post(new C06111(this, zzr.zzbE().zza(this.zzEv.mActivity, zzf, this.zzEv.zzEh.zzEM.zzqo, this.zzEv.zzEh.zzEM.zzqp)));
            }
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            this.zzDm.setId(ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH);
    ...
    protected void zzx(boolean z) throws zza {
        ...
        if (!this.zzEo || (this.zzEh.zzEM != null && this.zzEh.zzEM.zzqm)) {
            window.setFlags(Flags.FLAG5, Flags.FLAG5);
        }
        ...
        if (z) {
            ...
            this.zzpD.zzhU().zza(new C06101(this));
            if (this.zzEh.url != null) {
                this.zzpD.loadUrl(this.zzEh.url);
            } else if (this.zzEh.zzEH != null) {
                this.zzpD.loadDataWithBaseURL(this.zzEh.zzEF, this.zzEh.zzEH, WebRequest.CONTENT_TYPE_HTML, HttpRequest.CHARSET_UTF8, null);
            } else {
