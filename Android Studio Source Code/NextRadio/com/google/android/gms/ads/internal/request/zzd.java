...
public abstract class zzd implements com.google.android.gms.ads.internal.request.zzc.zza, zzit<Void> {
    ...
    class C06181 implements zzc<AdRequestInfoParcel> {
        final /* synthetic */ zzj zzHn;
        final /* synthetic */ zzd zzHo;

        C06181(zzd com_google_android_gms_ads_internal_request_zzd, zzj com_google_android_gms_ads_internal_request_zzj) {
    ...
    class C06192 implements com.google.android.gms.internal.zzji.zza {
        final /* synthetic */ zzd zzHo;

        C06192(zzd com_google_android_gms_ads_internal_request_zzd) {
            this.zzHo = com_google_android_gms_ads_internal_request_zzd;
        }
    ...
    public static class zzb extends zzd implements ConnectionCallbacks, OnConnectionFailedListener {
        ...
        public void onConnectionFailed(@NonNull ConnectionResult result) {
            ...
            bundle.putString(locationTracking.action, "gms_connection_failed_fallback_to_local");
    ...
    public Void zzga() {
        ...
        if (zzgs == null) {
            ...
            this.zzHl.zza(new C06181(this, zzgs), new C06192(this));
        }
        return null;
    }
