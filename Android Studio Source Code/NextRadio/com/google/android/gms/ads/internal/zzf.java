...
public class zzf extends zzc implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C06311 implements zzb {
        final /* synthetic */ zzif zzpF;
        final /* synthetic */ zzf zzpG;

        C06311(zzf com_google_android_gms_ads_internal_zzf, zzif com_google_android_gms_internal_zzif) {
        ...
        if (this.zzpj.zzbW()) {
            if (com_google_android_gms_internal_zzif.zzED != null) {
                ...
                if (com_google_android_gms_internal_zzif.zzcv()) {
                    ...
                    com_google_android_gms_internal_zzif.zzED.zzhU().zza(new C06311(this, com_google_android_gms_internal_zzif));
                }
            }
