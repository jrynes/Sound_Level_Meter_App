...
public class zzk extends FrameLayout implements zzh {
    ...
    private void zzfJ() {
        if (this.zzpD.zzhP() != null && !this.zzEQ) {
            this.zzER = (this.zzpD.zzhP().getWindow().getAttributes().flags & Flags.FLAG8) != 0;
            if (!this.zzER) {
                this.zzpD.zzhP().getWindow().addFlags(Flags.FLAG8);
                this.zzEQ = true;
            }
        }
    }
    ...
    private void zzfK() {
        if (this.zzpD.zzhP() != null && this.zzEQ && !this.zzER) {
            this.zzpD.zzhP().getWindow().clearFlags(Flags.FLAG8);
            this.zzEQ = false;
        }
    }
    ...
    public void zzg(String str, String str2) {
        zza(Diagnostics.error, "what", str, "extra", str2);
    }
}
