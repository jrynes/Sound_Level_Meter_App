...
public class GoogleSignInAccount implements SafeParcelable {
    ...
    static class C06721 implements Comparator<Scope> {
        C06721() {
        }
    ...
    public static GoogleSignInAccount zzbH(@Nullable String str) throws JSONException {
        ...
        return zza(jSONObject.optString(Name.MARK), jSONObject.optString("tokenId", null), jSONObject.optString(Scopes.EMAIL, null), jSONObject.optString(AdMarvelNativeAd.FIELD_DISPLAYNAME, null), parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzbI(jSONObject.optString("serverAuthCode", null));
    }
    ...
    private JSONObject zzmJ() {
        ...
        try {
            ...
            if (getDisplayName() != null) {
                jSONObject.put(AdMarvelNativeAd.FIELD_DISPLAYNAME, getDisplayName());
            }
            if (getPhotoUrl() != null) {
