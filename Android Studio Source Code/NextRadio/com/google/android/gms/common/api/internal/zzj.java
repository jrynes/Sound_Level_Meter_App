...
public final class zzj extends GoogleApiClient implements com.google.android.gms.common.api.internal.zzp.zza {
    ...
    class C06891 implements zzd {
        final /* synthetic */ zzj zzaid;

        C06891(zzj com_google_android_gms_common_api_internal_zzj) {
    ...
    class C06902 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzj zzaid;

        C06902(zzj com_google_android_gms_common_api_internal_zzj) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        }
    ...
    class C06913 implements ConnectionCallbacks {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ AtomicReference zzaie;
        final /* synthetic */ zzv zzaif;

        C06913(zzj com_google_android_gms_common_api_internal_zzj, AtomicReference atomicReference, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
    ...
    class C06924 implements OnConnectionFailedListener {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;

        C06924(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
        }
    ...
    class C06935 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;
        final /* synthetic */ boolean zzaig;

        C06935(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv, boolean z, GoogleApiClient googleApiClient) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
            this.zzaig = z;
    ...
    class C06946 implements Runnable {
        ...
        C06946(zzj com_google_android_gms_common_api_internal_zzj, FragmentActivity fragmentActivity) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
    ...
    public zzj(Context context, Lock lock, Looper looper, zzf com_google_android_gms_common_internal_zzf, com.google.android.gms.common.zzc com_google_android_gms_common_zzc, com.google.android.gms.common.api.Api.zza<? extends zzrn, zzro> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzrn__com_google_android_gms_internal_zzro, Map<Api<?>, Integer> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<com.google.android.gms.common.api.Api.zzc<?>, com.google.android.gms.common.api.Api.zzb> map2, int i, int i2, ArrayList<zzc> arrayList) {
        ...
        this.zzahZ = null;
        this.zzaia = null;
        this.zzaib = new C06891(this);
        this.zzaic = new C06902(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzv com_google_android_gms_common_api_internal_zzv, boolean z) {
        zzmf.zzamA.zzf(googleApiClient).setResultCallback(new C06935(this, com_google_android_gms_common_api_internal_zzv, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzahT.containsKey(zzmf.zzUI)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzmf.API).addConnectionCallbacks(new C06913(this, atomicReference, com_google_android_gms_common_api_internal_zzv)).addOnConnectionFailedListener(new C06924(this, com_google_android_gms_common_api_internal_zzv)).setHandler(this.zzahR).build();
    ...
    public void stopAutoManage(@NonNull FragmentActivity lifecycleActivity) {
        if (this.zzagp >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C06946(this, lifecycleActivity));
                return;
            } else {
                zza.zzbD(this.zzagp);
                return;
    ...
    String zzpH() {
        ...
        dump(Stomp.EMPTY, null, new PrintWriter(stringWriter), null);
