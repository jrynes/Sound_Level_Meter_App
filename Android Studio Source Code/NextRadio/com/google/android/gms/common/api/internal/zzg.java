...
public class zzg implements zzk {
    ...
    class C06841 extends zza {
        final /* synthetic */ zzg zzahl;

        C06841(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
    ...
    class C06852 extends zza {
        ...
        C06852(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
            this.zzahl = com_google_android_gms_common_api_internal_zzg;
            super(com_google_android_gms_common_api_internal_zzk);
        }
    ...
    public void connect() {
        if (this.zzahk) {
            this.zzahk = false;
            this.zzahj.zza(new C06852(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzahj.zza(new C06841(this, this));
        }
        return t;
    }
