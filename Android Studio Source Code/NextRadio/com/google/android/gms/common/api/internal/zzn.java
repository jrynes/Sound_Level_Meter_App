...
abstract class zzn extends BroadcastReceiver {
    ...
    public static <T extends zzn> T zza(Context context, T t, zzc com_google_android_gms_common_zzc) {
        ...
        t.mContext = context;
        if (com_google_android_gms_common_zzc.zzi(context, AdvertisingInfoServiceStrategy.GOOGLE_PLAY_SERVICES_INTENT_PACKAGE_NAME)) {
            return t;
        }
        t.zzpJ();
        t.unregister();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AdvertisingInfoServiceStrategy.GOOGLE_PLAY_SERVICES_INTENT_PACKAGE_NAME.equals(obj)) {
            zzpJ();
            unregister();
        }
    }
