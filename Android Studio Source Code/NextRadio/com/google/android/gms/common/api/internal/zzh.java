...
public class zzh implements zzk {
    ...
    class C06861 implements Runnable {
        ...
        C06861(zzh com_google_android_gms_common_api_internal_zzh) {
    ...
    private class zzb extends zzf {
        ...
        class C06871 extends zza {
            final /* synthetic */ ConnectionResult zzahF;
            final /* synthetic */ zzb zzahG;

            C06871(zzb com_google_android_gms_common_api_internal_zzh_zzb, zzk com_google_android_gms_common_api_internal_zzk, ConnectionResult connectionResult) {
        ...
        public void zzpt() {
            ...
            if (isGooglePlayServicesAvailable != 0) {
                this.zzahC.zzahj.zza(new C06871(this, this.zzahC, new ConnectionResult(isGooglePlayServicesAvailable, null)));
                return;
            }
            if (this.zzahC.zzahu) {
    ...
    private static class zzd extends com.google.android.gms.signin.internal.zzb {
        ...
        class C06881 extends zza {
            final /* synthetic */ zzh zzahI;
            final /* synthetic */ SignInResponse zzahJ;
            final /* synthetic */ zzd zzahK;

            C06881(zzd com_google_android_gms_common_api_internal_zzh_zzd, zzk com_google_android_gms_common_api_internal_zzk, zzh com_google_android_gms_common_api_internal_zzh, SignInResponse signInResponse) {
        ...
        public void zzb(SignInResponse signInResponse) {
            zzh com_google_android_gms_common_api_internal_zzh = (zzh) this.zzahD.get();
            if (com_google_android_gms_common_api_internal_zzh != null) {
                com_google_android_gms_common_api_internal_zzh.zzahj.zza(new C06881(this, com_google_android_gms_common_api_internal_zzh, com_google_android_gms_common_api_internal_zzh, signInResponse));
            }
        }
    }
    ...
    private void zzpx() {
        this.zzahj.zzpL();
        zzm.zzpN().execute(new C06861(this));
        if (this.zzahs != null) {
            if (this.zzahx) {
