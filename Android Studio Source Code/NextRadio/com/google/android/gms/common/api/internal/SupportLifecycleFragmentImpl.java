...
public class SupportLifecycleFragmentImpl extends zzw {
    ...
    class C06801 extends zzn {
        final /* synthetic */ Dialog zzaiL;
        final /* synthetic */ SupportLifecycleFragmentImpl zzaiM;

        C06801(SupportLifecycleFragmentImpl supportLifecycleFragmentImpl, Dialog dialog) {
    ...
    protected void zzc(int i, ConnectionResult connectionResult) {
        this.zzaiD = zzn.zza(getActivity().getApplicationContext(), new C06801(this, zzpS().zza(getActivity(), this)));
    }
