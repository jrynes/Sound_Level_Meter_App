...
public class zze {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0588R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        if (!zzafR.get()) {
            ...
            synchronized (zzqy) {
                if (zzafO == null) {
                    ...
                    try {
                        Bundle bundle = context.getPackageManager().getApplicationInfo(context.getPackageName(), Flags.FLAG8).metaData;
                        if (bundle != null) {
    ...
    public static boolean zzaq(Context context) {
        if (zzne.zzsj()) {
            ...
            if (applicationRestrictions != null && Stomp.TRUE.equals(applicationRestrictions.getString("restricted_profile"))) {
                return true;
            }
        }
        return false;
    ...
    static boolean zzi(Context context, String str) {
        ...
        try {
            return context.getPackageManager().getApplicationInfo(str, Flags.FLAG2).enabled;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
