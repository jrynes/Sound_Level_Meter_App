...
public class zzfp extends zzfs {
    ...
    class C08411 implements OnClickListener {
        ...
        C08411(zzfp com_google_android_gms_internal_zzfp, String str, String str2) {
    ...
    class C08422 implements OnClickListener {
        ...
        C08422(zzfp com_google_android_gms_internal_zzfp) {
            this.zzDt = com_google_android_gms_internal_zzfp;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setTitle(zzr.zzbF().zzd(C0588R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzr.zzbF().zzd(C0588R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzr.zzbF().zzd(C0588R.string.accept, HttpRequest.HEADER_ACCEPT), new C08411(this, str, zzal));
                    zzL.setNegativeButton(zzr.zzbF().zzd(C0588R.string.decline, "Decline"), new C08422(this));
                    zzL.create().show();
                    return;
                }
