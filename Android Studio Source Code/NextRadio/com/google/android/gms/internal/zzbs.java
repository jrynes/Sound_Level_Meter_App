...
public class zzbs {
    ...
    class C07521 implements Callable<T> {
        final /* synthetic */ zzbp zzvy;
        final /* synthetic */ zzbs zzvz;

        C07521(zzbs com_google_android_gms_internal_zzbs, zzbp com_google_android_gms_internal_zzbp) {
    ...
    public <T> T zzd(zzbp<T> com_google_android_gms_internal_zzbp_T) {
        synchronized (this.zzpV) {
            if (this.zzqA) {
                return zzjb.zzb(new C07521(this, com_google_android_gms_internal_zzbp_T));
            }
