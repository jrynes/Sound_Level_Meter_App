...
public abstract class zzbp<T> {
    ...
    static class C07481 extends zzbp<Boolean> {
        C07481(int i, String str, Boolean bool) {
            super(str, bool, null);
        }
    ...
    static class C07492 extends zzbp<Integer> {
        C07492(int i, String str, Integer num) {
            super(str, num, null);
        }
    ...
    static class C07503 extends zzbp<Long> {
        C07503(int i, String str, Long l) {
            super(str, l, null);
        }
    ...
    static class C07514 extends zzbp<String> {
        C07514(int i, String str, String str2) {
            super(str, str2, null);
        }
