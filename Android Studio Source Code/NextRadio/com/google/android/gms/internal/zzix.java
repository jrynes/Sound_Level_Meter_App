...
public class zzix {
    ...
    class C08961 implements Runnable {
        ...
        C08961(zzix com_google_android_gms_internal_zzix) {
        ...
        public void run() {
            ...
            com.google.android.gms.internal.zzin.m1674v(r0);	 Catch:{ all -> 0x002a }
        L_0x000c:
        ...
        L_0x0014:
            ...
            com.google.android.gms.internal.zzin.m1674v(r0);	 Catch:{ InterruptedException -> 0x0023 }
            goto L_0x000c;
        L_0x0023:
            r0 = move-exception;
    ...
    public Looper zzhC() {
        ...
        synchronized (this.zzpV) {
            if (this.zzMH != 0) {
                ...
                zzin.m1674v("Starting the looper thread.");
                this.zzMG = new HandlerThread("LooperProvider");
                this.zzMG.start();
                this.mHandler = new Handler(this.zzMG.getLooper());
                zzin.m1674v("Looper thread started.");
            } else {
                zzin.m1674v("Resuming the looper thread");
                this.zzpV.notifyAll();
            }
            this.zzMH++;
    ...
    public void zzhD() {
        synchronized (this.zzpV) {
            ...
            this.zzMH = i;
            if (i == 0) {
                this.mHandler.post(new C08961(this));
            }
        }
    }
}
