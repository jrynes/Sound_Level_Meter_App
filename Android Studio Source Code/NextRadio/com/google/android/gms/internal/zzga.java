...
public class zzga extends Handler {
    ...
    private void zzd(JSONObject jSONObject) {
        try {
            this.zzFq.zza(jSONObject.getString("request_id"), jSONObject.getString("base_url"), jSONObject.getString(Constants.NATIVE_VIDEO_AD_HTML_ELEMENT));
        } catch (Exception e) {
        }
    }
    ...
    public void handleMessage(Message msg) {
        try {
            ...
            if (data != null) {
                JSONObject jSONObject = new JSONObject(data.getString(MPDbAdapter.KEY_DATA));
