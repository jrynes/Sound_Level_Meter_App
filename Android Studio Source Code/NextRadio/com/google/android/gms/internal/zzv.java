...
public class zzv implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) throws IOException {
            ...
            if (com_google_android_gms_internal_zzv_zza.zzb.equals(Stomp.EMPTY)) {
        ...
        public boolean zza(OutputStream outputStream) {
            try {
                ...
                zzv.zza(outputStream, this.zzb == null ? Stomp.EMPTY : this.zzb);
    ...
    static void zza(OutputStream outputStream, int i) throws IOException {
        outputStream.write((i >> 0) & Type.ANY);
        outputStream.write((i >> 8) & Type.ANY);
        outputStream.write((i >> 16) & Type.ANY);
        outputStream.write((i >> 24) & Type.ANY);
    }
