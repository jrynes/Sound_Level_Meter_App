...
public class zzjw extends zzjq {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, String url) {
        ...
        try {
            ...
            if (webView instanceof zzjp) {
                ...
                zzin.m1674v("shouldInterceptRequest(" + str + ")");
    ...
    protected WebResourceResponse zzd(Context context, String str, String str2) throws IOException, ExecutionException, InterruptedException, TimeoutException {
        ...
        hashMap.put(HttpRequest.HEADER_USER_AGENT, zzr.zzbC().zze(context, str));
        ...
        return str3 == null ? null : new WebResourceResponse(WebRequest.CONTENT_TYPE_JAVASCRIPT, HttpRequest.CHARSET_UTF8, new ByteArrayInputStream(str3.getBytes(HttpRequest.CHARSET_UTF8)));
    }
}
