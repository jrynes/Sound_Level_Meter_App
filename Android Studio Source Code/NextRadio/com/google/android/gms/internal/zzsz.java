...
public interface zzsz {
    ...
    public static final class zzb extends zzso<zzb> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.zzbuN.equals(Stomp.EMPTY)) {
                output.zzn(2, this.zzbuN);
            }
            if (!this.version.equals(Stomp.EMPTY)) {
        ...
        public zzb zzJD() {
            this.zzbuM = 0;
            this.zzbuN = Stomp.EMPTY;
            this.version = Stomp.EMPTY;
            this.zzbuj = null;
            this.zzbuu = -1;
            return this;
        }
        ...
        protected int zzz() {
            ...
            return !this.version.equals(Stomp.EMPTY) ? zzz + zzsn.zzo(3, this.version) : zzz;
        }
    }
    ...
    public static final class zzd extends zzso<zzd> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.tag.equals(Stomp.EMPTY)) {
            ...
            if (!this.zzbvc.equals(Stomp.EMPTY)) {
    ...
    public static final class zze extends zzso<zze> {
        ...
        public void writeTo(zzsn output) throws IOException {
            if (!this.key.equals(Stomp.EMPTY)) {
                output.zzn(1, this.key);
            }
            if (!this.value.equals(Stomp.EMPTY)) {
        ...
        protected int zzz() {
            ...
            return !this.value.equals(Stomp.EMPTY) ? zzz + zzsn.zzo(2, this.value) : zzz;
        }
    }
}
