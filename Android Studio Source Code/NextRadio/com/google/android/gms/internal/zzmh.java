...
public final class zzmh implements zzmg {
    ...
    class C09191 extends zza {
        final /* synthetic */ zzmh zzamB;

        C09191(zzmh com_google_android_gms_internal_zzmh, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzf(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C09191(this, googleApiClient));
    }
}
