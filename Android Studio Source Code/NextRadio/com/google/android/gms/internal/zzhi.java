...
class zzhi {
    ...
    public zzhi(int i, Map<String, String> map) {
        this.zzF = (String) map.get(SettingsJsonConstants.APP_URL_KEY);
        ...
        this.zzJN = (String) map.get(Send.TYPE);
        this.zzJI = zzav((String) map.get("errors"));
        this.zzGu = i;
    }

    private static boolean parseBoolean(String bool) {
        return bool != null && (bool.equals("1") || bool.equals(Stomp.TRUE));
    }

    private List<String> zzav(String str) {
        return str == null ? null : Arrays.asList(str.split(Stomp.COMMA));
    }
