...
public class zzbf extends Thread {
    ...
    class C07431 implements Runnable {
        ...
        C07431(zzbf com_google_android_gms_internal_zzbf, View view) {
    ...
    class C07452 implements Runnable {
        ...
        class C07441 implements ValueCallback<String> {
            final /* synthetic */ C07452 zztl;

            C07441(C07452 c07452) {
                this.zztl = c07452;
            }
        ...
        C07452(zzbf com_google_android_gms_internal_zzbf, zzbc com_google_android_gms_internal_zzbc, WebView webView, boolean z) {
            this.zztg = com_google_android_gms_internal_zzbf;
            this.zzti = com_google_android_gms_internal_zzbc;
            this.zztj = webView;
            this.zztk = z;
            this.zzth = new C07441(this);
        }
        ...
        public void run() {
            if (this.zztj.getSettings().getJavaScriptEnabled()) {
                try {
                    ...
                    this.zzth.onReceiveValue(Stomp.EMPTY);
                }
            }
        }
    }
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (TextUtils.isEmpty(webView.getTitle())) {
                    ...
                    com_google_android_gms_internal_zzbc.zzc(webView.getTitle() + Stomp.NEWLINE + optString, z);
                }
            }
    ...
    boolean zza(WebView webView, zzbc com_google_android_gms_internal_zzbc, boolean z) {
        ...
        com_google_android_gms_internal_zzbc.zzcC();
        webView.post(new C07452(this, com_google_android_gms_internal_zzbc, webView, z));
        return true;
    }
    ...
    boolean zze(View view) {
        ...
        view.post(new C07431(this, view));
        return true;
    }
