...
public class zzbk {
    ...
    static String zza(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zzb.m1672e("Unable to construct shingle");
            return Stomp.EMPTY;
        }
    ...
    private static long zzb(String[] strArr, int i, int i2) {
        long zzx = (((long) zzbi.zzx(strArr[i])) + TTL.MAX_VALUE) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            zzx = (((zzx * 16785407) % 1073807359) + ((((long) zzbi.zzx(strArr[i3])) + TTL.MAX_VALUE) % 1073807359)) % 1073807359;
        }
        return zzx;
    }
}
