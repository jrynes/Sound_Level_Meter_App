...
public class zzrp {
    ...
    public zzrp(Context context, int i, String str, String str2, String str3) {
        ...
        if (zzni.zzcV(str3) || AdvertisingInfoServiceStrategy.GOOGLE_PLAY_SERVICES_INTENT_PACKAGE_NAME == str3) {
            this.zzanQ = str;
        } else {
        ...
        if (zznj.zzaA(this.mContext)) {
            if (zzni.zzcV(str3)) {
                if (zzd.zzakE && zzlz.isInitialized()) {
                    ...
                    str3 = AdvertisingInfoServiceStrategy.GOOGLE_PLAY_SERVICES_INTENT_PACKAGE_NAME;
                } else {
