...
public class InstanceID {
    ...
    public static synchronized InstanceID zza(Context context, Bundle bundle) {
        ...
        synchronized (InstanceID.class) {
            String string = bundle == null ? Stomp.EMPTY : bundle.getString("subtype");
            String str = string == null ? Stomp.EMPTY : string;
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + 112) & Type.ANY);
    ...
    public void deleteInstanceID() throws IOException {
        zzb(DestinationFilter.ANY_CHILD, DestinationFilter.ANY_CHILD, null);
        zzyA();
    }
    ...
    public String getToken(String authorizedEntity, String scope, Bundle extras) throws IOException {
        ...
        if (zzi == null) {
            ...
            if (!"jwt".equals(extras.getString(Send.TYPE))) {
                obj = obj2;
            }
    ...
    public void zzb(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString(Message.SUBSCRIPTION, str);
        bundle.putString("delete", "1");
        bundle.putString("X-delete", "1");
        bundle.putString("subtype", Stomp.EMPTY.equals(this.zzaMT) ? str : this.zzaMT);
        String str3 = "X-subtype";
        if (!Stomp.EMPTY.equals(this.zzaMT)) {
            str = this.zzaMT;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("sender", str);
        String str3 = Stomp.EMPTY.equals(this.zzaMT) ? str : this.zzaMT;
