...
public class InstanceIDListenerService extends Service {
    ...
    class C07281 extends Handler {
        ...
        C07281(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C07292 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C07292(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }
    ...
    static {
        ACTION = locationTracking.action;
    ...
    public InstanceIDListenerService() {
        this.zzaMW = new MessengerCompat(new C07281(this, Looper.getMainLooper()));
        this.zzaMX = new C07292(this);
    }
    ...
    public void zzp(Intent intent) {
        ...
        if (intent.getStringExtra(Diagnostics.error) == null && intent.getStringExtra("registration_id") == null) {
            if (Log.isLoggable("InstanceID", 3)) {
