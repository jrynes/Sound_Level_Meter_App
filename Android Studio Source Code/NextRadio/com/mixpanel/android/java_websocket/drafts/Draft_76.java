...
public class Draft_76 extends Draft_75 {
    ...
    static {
        closehandshake = new byte[]{(byte) -1, (byte) 0};
    }
    ...
    private static String generateKey() {
        ...
        String key = Long.toString(((long) (r.nextInt(Math.abs(new Long(LongString.MAX_LENGTH / spaces).intValue())) + 1)) * spaces);
    ...
    private static byte[] getPart(String key) throws InvalidHandshakeException {
        try {
            long keyNumber = Long.parseLong(key.replaceAll("[^0-9]", Stomp.EMPTY));
    ...
    public List<Framedata> translateFrame(ByteBuffer buffer) throws InvalidDataException {
        ...
        if (this.currentFrame == null) {
            ...
            if (this.currentFrame.hasRemaining()) {
                ...
                frames.add(new CloseFrameBuilder(ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH));
                return frames;
            } else {
                throw new InvalidFrameException();
            }
