...
public class ValueAnimator extends Animator {
    ...
    static class C12491 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C12491() {
        }
    ...
    static class C12502 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C12502() {
        }
    ...
    static class C12513 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C12513() {
        }
    ...
    static class C12524 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C12524() {
        }
    ...
    static class C12535 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C12535() {
        }
    ...
    static {
        ...
        sAnimations = new C12491();
        sPendingAnimations = new C12502();
        sDelayedAnims = new C12513();
        sEndingAnims = new C12524();
        sReadyAnims = new C12535();
    ...
    public void setIntValues(int... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                ...
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofInt(Stomp.EMPTY, values);
    ...
    public void setFloatValues(float... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofFloat(Stomp.EMPTY, values);
                setValues(propertyValuesHolderArr);
            } else {
    ...
    public void setObjectValues(Object... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofObject(Stomp.EMPTY, (TypeEvaluator) null, values);
                setValues(propertyValuesHolderArr);
            } else {
