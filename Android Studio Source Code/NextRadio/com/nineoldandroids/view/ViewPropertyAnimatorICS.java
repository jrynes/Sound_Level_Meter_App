...
class ViewPropertyAnimatorICS extends ViewPropertyAnimator {
    ...
    class C12551 implements AnimatorListener {
        final /* synthetic */ Animator.AnimatorListener val$listener;

        C12551(Animator.AnimatorListener animatorListener) {
    ...
    public ViewPropertyAnimator setListener(Animator.AnimatorListener listener) {
        ...
        if (n != null) {
            if (listener == null) {
                ...
                n.setListener(new C12551(listener));
            }
        }
        return this;
    }
    ...
    public ViewPropertyAnimator m1941x(float value) {
        ViewPropertyAnimator n = (ViewPropertyAnimator) this.mNative.get();
        if (n != null) {
            n.x(value);
        }
    ...
    public ViewPropertyAnimator m1942y(float value) {
        ViewPropertyAnimator n = (ViewPropertyAnimator) this.mNative.get();
        if (n != null) {
            n.y(value);
        }
