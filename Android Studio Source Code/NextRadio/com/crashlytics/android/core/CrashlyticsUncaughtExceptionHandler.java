...
class CrashlyticsUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    class 10 implements Callable<Void> {
        10() {
        }
    ...
    class 11 implements Callable<Boolean> {
        11() {
        }
    ...
    class 13 implements FilenameFilter {
    ...
    static class C03782 implements Comparator<File> {
        C03782() {
        }
    ...
    static class C03793 implements Comparator<File> {
        C03793() {
        }
    ...
    static class C03804 implements FilenameFilter {
        C03804() {
        }
    ...
    class C03815 implements Callable<Void> {
        final /* synthetic */ Throwable val$ex;
        final /* synthetic */ Date val$now;
        final /* synthetic */ Thread val$thread;

        C03815(Date date, Thread thread, Throwable th) {
            this.val$now = date;
    ...
    class C03826 implements Callable<Void> {
        final /* synthetic */ String val$msg;
        final /* synthetic */ long val$timestamp;

        C03826(long j, String str) {
    ...
    class C03837 implements Runnable {
        final /* synthetic */ Throwable val$ex;
        final /* synthetic */ Date val$now;
        final /* synthetic */ Thread val$thread;

        C03837(Date date, Thread thread, Throwable th) {
            this.val$now = date;
            this.val$thread = thread;
            this.val$ex = th;
        }
    ...
    class C03848 implements Callable<Void> {
        final /* synthetic */ String val$userEmail;
        final /* synthetic */ String val$userId;
        final /* synthetic */ String val$userName;

        C03848(String str, String str2, String str3) {
            this.val$userId = str;
    ...
    class C03859 implements Callable<Void> {
    ...
    static {
        SESSION_FILE_FILTER = new C03771();
        LARGEST_FILE_NAME_FIRST = new C03782();
        SMALLEST_FILE_NAME_FIRST = new C03793();
        ANY_SESSION_FILENAME_FILTER = new C03804();
    ...
    public synchronized void uncaughtException(Thread thread, Throwable ex) {
        ...
        try {
            ...
            this.executorServiceWrapper.executeSyncLoggingException(new C03815(new Date(), thread, ex));
    ...
    void writeToLog(long timestamp, String msg) {
        this.executorServiceWrapper.executeAsync(new C03826(timestamp, msg));
    }

    void writeNonFatalException(Thread thread, Throwable ex) {
        this.executorServiceWrapper.executeAsync(new C03837(new Date(), thread, ex));
    }

    void cacheUserData(String userId, String userName, String userEmail) {
        this.executorServiceWrapper.executeAsync(new C03848(userId, userName, userEmail));
    }

    void cacheKeyData(Map<String, String> keyData) {
        this.executorServiceWrapper.executeAsync(new C03859(keyData));
    }

    void openSession() {
        this.executorServiceWrapper.executeAsync(new 10());
    }
    ...
    boolean finalizeSessions() {
        return ((Boolean) this.executorServiceWrapper.executeSyncLoggingException(new 11())).booleanValue();
    }
    ...
    void cleanInvalidTempFiles() {
        this.executorServiceWrapper.executeAsync(new 12());
    }
    ...
    void doCleanInvalidTempFiles(File[] invalidFiles) {
        ...
        for (int i = 0; i < len$; i += ANALYZER_VERSION) {
            ...
            FilenameFilter sessionFilter = new 13(sessionId);
