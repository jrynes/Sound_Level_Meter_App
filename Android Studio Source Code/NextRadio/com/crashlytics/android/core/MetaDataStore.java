...
class MetaDataStore {
    ...
    static class C03891 extends JSONObject {
        final /* synthetic */ UserMetaData val$userData;

        C03891(UserMetaData userMetaData) throws JSONException {
    ...
    private static String userDataToJson(UserMetaData userData) throws JSONException {
        return new C03891(userData).toString();
    }
