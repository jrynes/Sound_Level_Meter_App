...
final class CodedOutputStream implements Flushable {
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & Service.LOCUS_CON) | Flags.FLAG8);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & Service.LOCUS_CON) | Flags.FLAG8);
            value >>>= 7;
        }
    ...
    public void writeRawLittleEndian32(int value) throws IOException {
        writeRawByte(value & Type.ANY);
        writeRawByte((value >> LITTLE_ENDIAN_64_SIZE) & Type.ANY);
        writeRawByte((value >> 16) & Type.ANY);
        writeRawByte((value >> 24) & Type.ANY);
    }

    public void writeRawLittleEndian64(long value) throws IOException {
        writeRawByte(((int) value) & Type.ANY);
        writeRawByte(((int) (value >> LITTLE_ENDIAN_64_SIZE)) & Type.ANY);
        writeRawByte(((int) (value >> 16)) & Type.ANY);
        writeRawByte(((int) (value >> 24)) & Type.ANY);
        writeRawByte(((int) (value >> 32)) & Type.ANY);
        writeRawByte(((int) (value >> 40)) & Type.ANY);
        writeRawByte(((int) (value >> 48)) & Type.ANY);
        writeRawByte(((int) (value >> 56)) & Type.ANY);
    }
