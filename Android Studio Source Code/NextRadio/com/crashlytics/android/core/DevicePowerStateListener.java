...
class DevicePowerStateListener {
    ...
    class C03861 extends BroadcastReceiver {
        C03861() {
        }
    ...
    class C03872 extends BroadcastReceiver {
        C03872() {
        }
    ...
    public DevicePowerStateListener(Context context) {
        ...
        this.powerConnectedReceiver = new C03861();
        this.powerDisconnectedReceiver = new C03872();
