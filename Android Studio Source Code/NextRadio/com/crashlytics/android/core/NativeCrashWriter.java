...
class NativeCrashWriter {
    ...
    private static final class ApplicationMessage extends ProtobufMessage {
        ...
        public ApplicationMessage(ExecutionMessage executionMessage, RepeatedMessage customAttrs) {
            super(PROTOBUF_TAG, executionMessage, customAttrs);
        }
    }
    ...
    private static final class BinaryImageMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            ...
            return ((CodedOutputStream.computeBytesSize(3, ByteString.copyFromUtf8(this.filePath)) + addrSize) + CodedOutputStream.computeUInt64Size(2, this.imageSize)) + CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.uuid));
        }
        ...
        public void writeProperties(CodedOutputStream cos) throws IOException {
            ...
            cos.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.uuid));
        }
    }
    ...
    private static final class CustomAttributeMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            return CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8(this.key)) + CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.value == null ? Stomp.EMPTY : this.value));
        }

        public void writeProperties(CodedOutputStream cos) throws IOException {
            cos.writeBytes(1, ByteString.copyFromUtf8(this.key));
            cos.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.value == null ? Stomp.EMPTY : this.value));
        }
    }
    ...
    private static final class DeviceMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            return (((((0 + CodedOutputStream.computeFloatSize(1, this.batteryLevel)) + CodedOutputStream.computeSInt32Size(2, this.batteryVelocity)) + CodedOutputStream.computeBoolSize(3, this.proximityOn)) + CodedOutputStream.computeUInt32Size(4, this.orientation)) + CodedOutputStream.computeUInt64Size(PROTOBUF_TAG, this.ramUsed)) + CodedOutputStream.computeUInt64Size(6, this.diskUsed);
        }
        ...
        public void writeProperties(CodedOutputStream cos) throws IOException {
            ...
            cos.writeUInt64(PROTOBUF_TAG, this.ramUsed);
    ...
    private static final class ExecutionMessage extends ProtobufMessage {
        ...
        public ExecutionMessage(SignalMessage signalMessage, RepeatedMessage threads, RepeatedMessage binaryImages) {
            super(PROTOBUF_TAG, threads, signalMessage, binaryImages);
        }
    }
    ...
    private static final class SignalMessage extends ProtobufMessage {
        ...
        public int getPropertiesSize() {
            return (CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8(this.sigName)) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(this.sigCode))) + CodedOutputStream.computeUInt64Size(PROTOBUF_TAG, this.sigAddr);
        }

        public void writeProperties(CodedOutputStream cos) throws IOException {
            cos.writeBytes(1, ByteString.copyFromUtf8(this.sigName));
            cos.writeBytes(2, ByteString.copyFromUtf8(this.sigCode));
            cos.writeUInt64(PROTOBUF_TAG, this.sigAddr);
        }
    }
    ...
    private static final class ThreadMessage extends ProtobufMessage {
        ...
        public ThreadMessage(ThreadData threadData, RepeatedMessage frames) {
            ProtobufMessage[] protobufMessageArr = new ProtobufMessage[PROTOBUF_TAG];
            protobufMessageArr[0] = frames;
            super(PROTOBUF_TAG, protobufMessageArr);
            this.name = threadData.name;
            this.importance = threadData.importance;
        }

        public int getPropertiesSize() {
            return CodedOutputStream.computeUInt32Size(2, this.importance) + (hasName() ? CodedOutputStream.computeBytesSize(PROTOBUF_TAG, ByteString.copyFromUtf8(this.name)) : 0);
        }

        public void writeProperties(CodedOutputStream cos) throws IOException {
            if (hasName()) {
                cos.writeBytes(PROTOBUF_TAG, ByteString.copyFromUtf8(this.name));
            }
    ...
    static {
        DEFAULT_SIGNAL = new SignalData(Stomp.EMPTY, Stomp.EMPTY, 0);
