...
class ReportUploader {
    ...
    static class C03911 implements FilenameFilter {
        C03911() {
        }
    ...
    static {
        crashFileFilter = new C03911();
        HEADER_INVALID_CLS_FILE = Collections.singletonMap("X-CRASHLYTICS-INVALID-SESSION", "1");
        RETRY_INTERVALS = new short[]{(short) 10, (short) 20, (short) 30, (short) 60, (short) 120, TSIG.FUDGE};
    }
