...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00071 extends FragmentContainer {
        C00071() {
        }
    ...
    final void setIndex(int index, Fragment parent) {
        this.mIndex = index;
        if (parent != null) {
            this.mWho = parent.mWho + Headers.SEPERATOR + this.mIndex;
        } else {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (!this.mUserVisibleHint && isVisibleToUser && this.mState < STARTED && this.mFragmentManager != null) {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mChildFragmentManager != null) {
            writer.print(prefix);
            writer.println("Child " + this.mChildFragmentManager + Headers.SEPERATOR);
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C00071(), this);
    }
