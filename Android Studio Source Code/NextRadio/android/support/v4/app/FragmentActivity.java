...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestIndex != 0) {
            ...
            if (targetFragment == null) {
                ...
                targetFragment.onActivityResult(org.xbill.DNS.Message.MAXLENGTH & requestCode, resultCode, data);
                return;
            }
        }
    ...
    private static String viewToString(View view) {
        ...
        char c2 = 'F';
        char c3 = '.';
        StringBuilder out = new StringBuilder(Flags.FLAG8);
        ...
        out.append(ActiveMQDestination.COMPOSITE_SEPERATOR);
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || r == null)) {
                ...
                out.append(" ");
                out.append(pkgname);
                out.append(Headers.SEPERATOR);
                out.append(typename);
                out.append(ReadOnlyContext.SEPARATOR);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        int index = (requestCode >> 8) & Type.ANY;
        if (index != 0) {
            index--;
            ...
            if (frag == null) {
                ...
                frag.onRequestPermissionsResult(requestCode & Type.ANY, permissions, grantResults);
            }
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int requestCode, @Nullable Bundle options) {
        ...
        if (requestCode == -1) {
            ...
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + MSG_REALLY_STOPPED) << 16) + (org.xbill.DNS.Message.MAXLENGTH & requestCode), options);
            this.mStartedActivityFromFragment = false;
        }
    }
    ...
    private void requestPermissionsFromFragment(Fragment fragment, String[] permissions, int requestCode) {
        if (requestCode == -1) {
            ...
            ActivityCompat.requestPermissions(this, permissions, ((fragment.mIndex + MSG_REALLY_STOPPED) << 8) + (requestCode & Type.ANY));
        }
    }
}
