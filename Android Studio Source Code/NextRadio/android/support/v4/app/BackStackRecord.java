...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00041 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C00041(Fragment fragment) {
            ...
            while (op != null) {
                ...
                switch (op.cmd) {
                    ...
                    case OP_REPLACE /*2*/:
                        ...
                        break;
                    case OP_REMOVE /*3*/:
                        cmdStr = ScheduledMessage.AMQ_SCHEDULER_ACTION_REMOVE;
                        break;
                    case OP_HIDE /*4*/:
                        cmdStr = "HIDE";
                        break;
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        C00041 c00041 = new C00041(inFragment);
        ...
        if (transition != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, exitTransition, sceneRoot, c00041, state.nonExistentView, state.enteringEpicenterView, state.nameOverrides, enteringViews, exitingViews, namedViews, renamedViews, sharedElementTargets);
