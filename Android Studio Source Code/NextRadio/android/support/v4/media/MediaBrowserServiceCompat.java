...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C00372 implements Runnable {
        ...
        C00372(String str, Bundle bundle) {
    ...
    class C00383 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C00383(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C00394 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C00394(Object debug, ResultReceiver resultReceiver) {
    ...
    class MediaBrowserServiceImplApi24 implements MediaBrowserServiceImpl {
        ...
        public void onCreate() {
            this.mServiceObj = MediaBrowserServiceCompatApi24.createService();
            MediaBrowserServiceCompatApi24.onCreate(this.mServiceObj, new ServiceImplApi24(null));
        }
    ...
    private class ServiceCallbacksApi21 implements ServiceCallbacks {
        final android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacksApi21 mCallbacks;
        Messenger mMessenger;

        ServiceCallbacksApi21(android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacksApi21 callbacks) {
    ...
    private class ServiceCallbacksApi24 extends ServiceCallbacksApi21 {
        final android.support.v4.media.MediaBrowserServiceCompatApi24.ServiceCallbacksApi24 mCallbacks;

        ServiceCallbacksApi24(android.support.v4.media.MediaBrowserServiceCompatApi24.ServiceCallbacksApi24 callbacks) {
            super(callbacks);
            this.mCallbacks = callbacks;
        }
        ...
        public void onLoadChildren(String mediaId, List<MediaItem> list, Bundle options) throws RemoteException {
            ...
            if (options == null) {
                ...
                this.mCallbacks.onLoadChildren(mediaId, parcelList, options);
            }
        }
    }
    ...
    private class ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceImplApi21 {
        ...
        public void connect(String pkg, Bundle rootHints, android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacksApi21 callbacks) {
            this.mServiceImpl.connect(pkg, Binder.getCallingUid(), rootHints, new ServiceCallbacksApi21(callbacks));
        }

        public void disconnect(android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacksApi21 callbacks) {
            this.mServiceImpl.disconnect(new ServiceCallbacksApi21(callbacks));
        }

        public void addSubscription(String id, android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacksApi21 callbacks) {
            this.mServiceImpl.addSubscription(id, null, new ServiceCallbacksApi21(callbacks));
        }

        public void removeSubscription(String id, android.support.v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacksApi21 callbacks) {
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C00461 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C00461(Handler handler, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new C00461(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }

    private class ServiceImplApi24 extends ServiceImplApi23 implements android.support.v4.media.MediaBrowserServiceCompatApi24.ServiceImplApi24 {
        private ServiceImplApi24() {
            super(null);
        }

        public void connect(String pkg, Bundle rootHints, android.support.v4.media.MediaBrowserServiceCompatApi24.ServiceCallbacksApi24 callbacks) {
            this.mServiceImpl.connect(pkg, Binder.getCallingUid(), rootHints, new ServiceCallbacksApi24(callbacks));
        }

        public void addSubscription(String id, Bundle options, android.support.v4.media.MediaBrowserServiceCompatApi24.ServiceCallbacksApi24 callbacks) {
            this.mServiceImpl.addSubscription(id, options, new ServiceCallbacksApi24(callbacks));
        }

        public void removeSubscription(String id, Bundle options, android.support.v4.media.MediaBrowserServiceCompatApi24.ServiceCallbacksApi24 callbacks) {
            this.mServiceImpl.removeSubscription(id, options, new ServiceCallbacksApi24(callbacks));
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00361(token));
        }
    }
    ...
    private void notifyChildrenChangedInternal(String parentId, Bundle options) {
        ...
        this.mHandler.post(new C00372(parentId, options));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C00383(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C00394(itemId, receiver);
