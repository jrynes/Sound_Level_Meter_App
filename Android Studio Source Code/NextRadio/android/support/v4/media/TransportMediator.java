...
public class TransportMediator extends TransportController {
    ...
    class C00501 implements TransportMediatorCallback {
        C00501() {
        }
    ...
    class C00512 implements Callback {
        C00512() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C00501();
        this.mKeyEventCallback = new C00512();
