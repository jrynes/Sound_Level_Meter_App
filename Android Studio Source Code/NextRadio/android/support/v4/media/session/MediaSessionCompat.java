...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C00551 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C00551() {
            }
        ...
        class C00562 implements android.support.v4.media.session.MediaSessionCompatApi19.Callback {
            C00562() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C00551();
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            android.support.v4.media.session.MediaSessionCompatApi19.Callback cb19 = new C00562();
            if (VERSION.SDK_INT >= 18) {
