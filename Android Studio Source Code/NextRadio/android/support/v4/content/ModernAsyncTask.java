...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00212 extends WorkerRunnable<Params, Result> {
        C00212() {
            super();
        }
    ...
    class C00223 extends FutureTask<Result> {
        C00223(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00212();
        this.mFuture = new C00223(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00234.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
