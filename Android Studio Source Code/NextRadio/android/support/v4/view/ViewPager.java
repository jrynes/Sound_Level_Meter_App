...
public class ViewPager extends ViewGroup {
    ...
    static class C00821 implements Comparator<ItemInfo> {
        C00821() {
        }
    ...
    static class C00832 implements Interpolator {
        C00832() {
        }
    ...
    class C00854 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == Flags.EXTEND && ViewPager.this.mAdapter != null) {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00861());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00821();
        sInterpolator = new C00832();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00843();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00854());
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & Type.ANY;
                ...
                switch (action & Type.ANY) {
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH, (float) this.mMaximumVelocity);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == Flags.EXTEND) {
