...
public class ViewDragHelper {
    ...
    static class C01171 implements Interpolator {
        C01171() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C01182();
        if (forParent == null) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH, this.mMaxVelocity);
