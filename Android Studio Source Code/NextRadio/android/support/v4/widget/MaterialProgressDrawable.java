...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01011 extends Animation {
    ...
    class C01022 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C01033 implements Callback {
        C01033() {
        }
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        int startA = (startInt >> 24) & Type.ANY;
        ...
        return ((((((int) (((float) (((endInt >> 24) & Type.ANY) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & Type.ANY) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & Type.ANY) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & Type.ANY) - startB)) * fraction)) + startB);
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C01011(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C01022(ring));
