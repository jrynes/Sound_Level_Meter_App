...
public class IdManager {
    ...
    public enum DeviceIdentifierType {
        ...
        FONT_TOKEN(53),
        ANDROID_ID(100),
        ANDROID_DEVICE_ID(Service.HOSTNAME),
        ANDROID_SERIAL(Service.ISO_TSAP),
        ANDROID_ADVERTISING_ID(Service.X400);
    ...
    static {
        ...
        FORWARD_SLASH_REGEX = Pattern.quote(ReadOnlyContext.SEPARATOR);
    }
    ...
    private String formatId(String id) {
        return id == null ? null : ID_PATTERN.matcher(id).replaceAll(Stomp.EMPTY).toLowerCase(Locale.US);
    }
    ...
    public String getOsVersionString() {
        return getOsDisplayVersionString() + ReadOnlyContext.SEPARATOR + getOsBuildVersionString();
    }
    ...
    private String removeForwardSlashesIn(String s) {
        return s.replaceAll(FORWARD_SLASH_REGEX, Stomp.EMPTY);
    }

    public String getDeviceUUID() {
        String toReturn = Stomp.EMPTY;
        if (!this.collectHardwareIds) {
            return toReturn;
        }
