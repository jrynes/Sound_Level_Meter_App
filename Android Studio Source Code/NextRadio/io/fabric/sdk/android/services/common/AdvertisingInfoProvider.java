...
class AdvertisingInfoProvider {
    ...
    class 1 extends BackgroundPriorityRunnable {
        ...
        1(AdvertisingInfo advertisingInfo) {
    ...
    private void refreshInfoIfNeededAsync(AdvertisingInfo advertisingInfo) {
        new Thread(new 1(advertisingInfo)).start();
    }
    ...
    protected AdvertisingInfo getInfoFromPreferences() {
        return new AdvertisingInfo(this.preferenceStore.get().getString(PREFKEY_ADVERTISING_ID, Stomp.EMPTY), this.preferenceStore.get().getBoolean(PREFKEY_LIMIT_AD_TRACKING, false));
    }
