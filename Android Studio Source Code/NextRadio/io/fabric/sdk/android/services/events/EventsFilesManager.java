...
public abstract class EventsFilesManager<T> {
    ...
    class 1 implements Comparator<FileWithTimestamp> {
        1() {
        }
    ...
    public boolean rollFileOver() throws IOException {
        ...
        if (!this.eventStorage.isWorkingFileEmpty()) {
            ...
            objArr[0] = targetFileName;
            CommonUtils.logControlled(context, 4, str, String.format(Locale.US, "generated new file %s", objArr));
            this.lastRollOverTime = this.currentTimeProvider.getCurrentTimeMillis();
            fileRolledOver = true;
        }
    ...
    public List<File> getBatchOfFilesToSend() {
        return this.eventStorage.getBatchOfFilesToSend(MAX_FILES_IN_BATCH);
    }
    ...
    public void deleteOldestInRollOverIfOverMax() {
        ...
        if (allFiles.size() > maxFiles) {
            ...
            TreeSet<FileWithTimestamp> sortedFiles = new TreeSet(new 1());
