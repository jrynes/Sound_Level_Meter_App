...
public final class Address {
    ...
    public static String toDottedQuad(byte[] addr) {
        return new StringBuffer().append(addr[0] & Type.ANY).append(ActiveMQDestination.PATH_SEPERATOR).append(addr[IPv4] & Type.ANY).append(ActiveMQDestination.PATH_SEPERATOR).append(addr[IPv6] & Type.ANY).append(ActiveMQDestination.PATH_SEPERATOR).append(addr[3] & Type.ANY).toString();
    }

    public static String toDottedQuad(int[] addr) {
        return new StringBuffer().append(addr[0]).append(ActiveMQDestination.PATH_SEPERATOR).append(addr[IPv4]).append(ActiveMQDestination.PATH_SEPERATOR).append(addr[IPv6]).append(ActiveMQDestination.PATH_SEPERATOR).append(addr[3]).toString();
    }
