...
public class LOCRecord extends Record {
    ...
    private long parsePosition(Tokenizer st, String type) throws IOException {
        boolean isLatitude = type.equals(locationTracking.latitude);
        int min = 0;
        double sec = 0.0d;
    ...
    void rdataFromString(Tokenizer st, Name origin) throws IOException {
        this.latitude = parsePosition(st, locationTracking.latitude);
        this.longitude = parsePosition(st, locationTracking.longitude);
