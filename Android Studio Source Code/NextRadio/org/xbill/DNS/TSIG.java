...
public class TSIG {
    ...
    public static class StreamVerifier {
        ...
        public StreamVerifier(TSIG tsig, TSIGRecord old) {
            this.key = tsig;
            this.verifier = new HMAC(TSIG.access$000(this.key), TSIG.access$100(this.key), TSIG.access$200(this.key));
            this.nresponses = 0;
            this.lastTSIG = old;
        }
        ...
        public int verify(Message m, byte[] b) {
            ...
            if (tsig != null) {
                ...
                if (tsig.getName().equals(TSIG.access$300(this.key)) && tsig.getAlgorithm().equals(TSIG.access$400(this.key))) {
                    ...
                    long timeLow = time & LongString.MAX_LENGTH;
    ...
    public TSIGRecord generate(Message m, byte[] b, int error, TSIGRecord old) {
        ...
        if (fudge < 0 || fudge > ActiveMQPrefetchPolicy.MAX_PREFETCH_SIZE) {
            fudge = 300;
        }
        if (old != null) {
            out = new DNSOutput();
        ...
        if (error == 18) {
            ...
            timeLow = time & LongString.MAX_LENGTH;
            out.writeU16((int) (time >> 32));
            out.writeU32(timeLow);
    ...
    public byte verify(Message m, byte[] b, int length, TSIGRecord old) {
        ...
        if (tsig.getName().equals(this.name)) {
            if (tsig.getAlgorithm().equals(this.alg)) {
