...
public class SimpleResolver implements Resolver {
    ...
    static {
        defaultResolver = ConnectionFactory.DEFAULT_HOST;
        uniqueID = 0;
    }

    public SimpleResolver(String hostname) throws UnknownHostException {
        InetAddress addr;
        this.timeoutValue = ThreadPoolUtils.DEFAULT_SHUTDOWN_AWAIT_TERMINATION;
        if (hostname == null) {
    ...
    public org.xbill.DNS.Message send(org.xbill.DNS.Message r19) throws java.io.IOException {
        /*
        r18 = this;
        r2 = "verbose";
    ...
    L_0x0056:
        r13 = r18.sendAXFR(r19);
    L_0x005a:
        return r13;
    L_0x005b:
        r19 = r19.clone();
        r19 = (org.xbill.DNS.Message) r19;
        r18.applyEDNS(r19);
        r0 = r18;
        r2 = r0.tsig;
