...
public class SIG0 {
    ...
    public static void signMessage(Message message, KEYRecord key, PrivateKey privkey, SIGRecord previous) throws DNSSECException {
        ...
        message.addRecord(DNSSEC.signMessage(message, previous, key, privkey, new Date(now), new Date(((long) (validity * ActiveMQPrefetchPolicy.DEFAULT_QUEUE_PREFETCH)) + now)), 3);
    }
