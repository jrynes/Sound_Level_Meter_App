...
public class MessageAckMarshaller extends BaseCommandMarshaller {
    ...
    public int tightMarshal1(OpenWireFormat wireFormat, Object o, BooleanStream bs) throws IOException {
        MessageAck info = (MessageAck) o;
        return ((((((super.tightMarshal1(wireFormat, o, bs) + tightMarshalCachedObject1(wireFormat, info.getDestination(), bs)) + tightMarshalCachedObject1(wireFormat, info.getTransactionId(), bs)) + tightMarshalCachedObject1(wireFormat, info.getConsumerId(), bs)) + tightMarshalNestedObject1(wireFormat, info.getFirstMessageId(), bs)) + tightMarshalNestedObject1(wireFormat, info.getLastMessageId(), bs)) + tightMarshalThrowable1(wireFormat, info.getPoisonCause(), bs)) + 5;
    }
