...
public abstract class BaseDataStreamMarshaller implements DataStreamMarshaller {
    ...
    protected Throwable tightUnmarsalThrowable(OpenWireFormat wireFormat, DataInput dataIn, BooleanStream bs) throws IOException {
        ...
        if (STACK_TRACE_ELEMENT_CONSTRUCTOR != null) {
            ...
            for (int i = 0; i < ss.length; i++) {
                try {
                    ss[i] = (StackTraceElement) STACK_TRACE_ELEMENT_CONSTRUCTOR.newInstance(new Object[]{tightUnmarshalString(dataIn, bs), tightUnmarshalString(dataIn, bs), tightUnmarshalString(dataIn, bs), new Integer(dataIn.readInt())});
                } catch (IOException e) {
                    throw e;
                } catch (Throwable th) {
                }
    ...
    protected Throwable looseUnmarsalThrowable(OpenWireFormat wireFormat, DataInput dataIn) throws IOException {
        ...
        if (STACK_TRACE_ELEMENT_CONSTRUCTOR != null) {
            ...
            for (int i = 0; i < ss.length; i++) {
                try {
                    ss[i] = (StackTraceElement) STACK_TRACE_ELEMENT_CONSTRUCTOR.newInstance(new Object[]{looseUnmarshalString(dataIn), looseUnmarshalString(dataIn), looseUnmarshalString(dataIn), new Integer(dataIn.readInt())});
                } catch (IOException e) {
                    throw e;
                } catch (Throwable th) {
                }
