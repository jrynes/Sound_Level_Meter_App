...
public class RemoveSubscriptionInfoMarshaller extends BaseCommandMarshaller {
    ...
    public int tightMarshal1(OpenWireFormat wireFormat, Object o, BooleanStream bs) throws IOException {
        RemoveSubscriptionInfo info = (RemoveSubscriptionInfo) o;
        return (((super.tightMarshal1(wireFormat, o, bs) + tightMarshalCachedObject1(wireFormat, info.getConnectionId(), bs)) + tightMarshalString1(info.getSubscriptionName(), bs)) + tightMarshalString1(info.getClientId(), bs)) + 0;
    }
