...
public class ProducerInfoMarshaller extends BaseCommandMarshaller {
    ...
    public int tightMarshal1(OpenWireFormat wireFormat, Object o, BooleanStream bs) throws IOException {
        ProducerInfo info = (ProducerInfo) o;
        return (((super.tightMarshal1(wireFormat, o, bs) + tightMarshalCachedObject1(wireFormat, info.getProducerId(), bs)) + tightMarshalCachedObject1(wireFormat, info.getDestination(), bs)) + tightMarshalObjectArray1(wireFormat, info.getBrokerPath(), bs)) + 0;
    }
